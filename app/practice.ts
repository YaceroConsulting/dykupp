...
export function repeatedDives(index: number = 0): TwoDives {
    ...
    const result: Array<TwoDives> = [
        ...
        },
        {
            ...
            maxRemaining: { consumed: 20, maxRemaining: 143 },
        },
        {
            startTime: startTime,
            firstDive: { time: 140, depth: 6, group: 'G' },
            surfaceTime: { hours: 1, minutes: 45, letter: 'D' },
            secondDive: { time: 160, depth: 6, group: 'I' },
            maxRemaining: { consumed: 82, maxRemaining: 518 },
        },
        {
            startTime: startTime,
            firstDive: { time: 72, depth: 16.4, group: 'L' },
        ...
        {
            startTime: startTime,
            firstDive: { time: 60, depth: 15, group: 'I' },
            surfaceTime: { hours: 1, minutes: 30, letter: 'K' },
            secondDive: { time: 60, depth: 15, group: 'M' },
            maxRemaining: {
                diveTimeAtDepth: 12,
                consumed: 80,
                maxExposition: 92,
        ...
        },
        {
            ...
            secondDive: { time: 60, depth: 15.5, group: 'L' },
            maxRemaining: {
                diveTimeAtDepth: 74,
                consumed: 0,
                maxExposition: 74,
        ...
        },
        {
            ...
            maxRemaining: { consumed: 44, maxRemaining: 119 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 78, maxRemaining: 517 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 63, maxRemaining: 29 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 36, maxRemaining: 127 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 48, maxRemaining: 44 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 27, maxRemaining: 136 },
        },
        {
            startTime: startTime,
            ...
            maxRemaining: { consumed: 14, maxRemaining: 60 },
        },
        {
            startTime: startTime,
            firstDive: { time: 24, depth: 27, group: 'G' },
            surfaceTime: { hours: 3, minutes: 0, letter: 'E' },
            secondDive: { time: 13, depth: 21, group: 'H' },
            maxRemaining: { consumed: 23, maxRemaining: 25 },
        },
        {
            startTime: startTime,
